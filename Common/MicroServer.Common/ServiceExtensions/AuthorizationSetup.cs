...
namespace MicroServer.Common.ServiceExtensions
{
    ...
    public static class AuthorizationSetup
    {
        public static void AddAuthorizationSetup(this IServiceCollection services)
        {
            ...
            var Issuer = ConfigurationManager.Appsettings.GetSection("Audience:Issuer").ObjToString();
            var Audience = ConfigurationManager.Appsettings.GetSection("Audience:Audience").ObjToString(); 
