...
namespace MicroServer.Common.ServiceExtensions
{
    ...
    public static class Authentication_JWTSetup
    {
        public static void AddAuthentication_JWTSetup(this IServiceCollection services)
        {
            ...
            var Issuer = ConfigurationManager.Appsettings.GetSection("Audience:Issuer").Value.ObjToString();
            var Audience = ConfigurationManager.Appsettings.GetSection("Audience:Audience").Value.ObjToString();
