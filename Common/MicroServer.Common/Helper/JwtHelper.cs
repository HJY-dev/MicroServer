...
namespace MicroServer.Common.Helper
{
    public class JwtHelper
    {
        ...
        {
            string iss = ConfigurationManager.Appsettings.GetSection("Audience:Issuer").Value;
            string aud = ConfigurationManager.Appsettings.GetSection("Audience:Audience").Value;
