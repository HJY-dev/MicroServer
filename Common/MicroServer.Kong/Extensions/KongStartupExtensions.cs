...
namespace MicroServer.Kong.Extensions
{
    public static class KongStartupExtensions
    {
        ...
        public static IApplicationBuilder UseKong(this IApplicationBuilder app, IConfiguration configuration, KongClient client)
        {
            ...
            return app.UseKong(client, upStream, target, service, route, null);
        }
        ...
        /// <returns></returns>
        public static IApplicationBuilder UseKong(this IApplicationBuilder app, KongClient client, UpStream upStream, TargetInfo target, ServiceInfo service, RouteInfo route)
        {
            return app.UseKong(client, upStream, target, service, route, null);
        }
        ...
        /// <returns></returns>
        public static IApplicationBuilder UseKong(this IApplicationBuilder app, KongClient client, UpStream upStream, TargetInfo target, ServiceInfo service, RouteInfo route, Action<HttpContext> onExecuter)
        {
            if (upStream == null)
